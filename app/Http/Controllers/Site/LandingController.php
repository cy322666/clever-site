...
class LandingController extends Controller
{
    ...
    private function resolveFormConfig(LandingPage $landing): array
    {
        $slugMap = [
            ...
            'perevnedrenie-amocrm' => [
                'title' => 'Начните перевнедрение CRM с аудита',
                'text' => 'Покажем, что можно сохранить, что нужно пересобрать и где текущая CRM создает хаос в продажах',
                'button' => 'Начать с аудита',
                'offer_type' => 'Аудит перед перевнедрением',
            ],
            'vnedrenie-amocrm' => [
