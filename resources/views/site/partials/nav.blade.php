...
<nav class="cmdf5-inspired-nav">
    <div class="cmd-nav-inner">
        ...
        <div class="cmd-mob-panel">
            ...
            <a href="{{ route('site.landings.show', 'vnedrenie-amocrm') }}" class="cmd-mob-sub">Внедрение</a>
            <a href="{{ route('site.landings.show', 'perevnedrenie-amocrm') }}" class="cmd-mob-sub">Перевнедрение</a>
            <a href="{{ route('site.landings.show', 'razrabotka-crm') }}" class="cmd-mob-sub">Разработка</a>
            <a href="{{ route('site.landings.show', 'analitika-prodazh-v-amocrm') }}" class="cmd-mob-sub">Аналитика</a>
            <a href="{{ route('site.landings.show', 'reanimaciya-amocrm') }}" class="cmd-mob-sub">Реанимация amoCRM</a>
            <a href="{{ route('site.landings.show', 'audit-amocrm') }}" class="cmd-mob-sub">Аудит amoCRM</a>
            ...
            <div class="cmd-mob-bottom">
                <div class="cmd-nav-socials">
                    <a href="{{ $topNavTelegramLink }}" target="_blank" rel="noreferrer" aria-label="Telegram"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21.2 4.4 2.4 10.8c-.6.2-.6.6 0 .8l4.8 1.8 1.8 5.8c.1.4.5.5.8.2l2.6-2.2 4.8 3.6c.4.3 1 .1 1.1-.4L22 5.2c.1-.6-.4-1-.8-.8Z"/><path d="m9 13.6 8.4-6.4"/></svg></a>
