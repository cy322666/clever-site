...
Route::view('/amocrm-license-renewal', 'site.license-renewal')->name('site.license-renewal');
...
Route::view('/policy', 'site.policy', [
    ...
    'metaDescription' => 'Политика обработки персональных данных CleverCRM: порядок сбора, хранения и защиты персональных данных.',
